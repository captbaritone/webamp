...
Class ToggleButton ToggleButton3Class;
...
Global ToggleButton3Class ToggleButton3Class35;
Global ToggleButton3Class ToggleButton3Class36;
Global ToggleButton3Class ToggleButton3Class37;
Global ToggleButton3Class ToggleButton3Class38;
Global ToggleButton3Class ToggleButton3Class39;
...
Global ToggleButton3Class ToggleButton3Class159;
Global ToggleButton3Class ToggleButton3Class160;
Global ToggleButton3Class ToggleButton3Class161;
...
func7247(( ( ( ( ( ( ( "SEEK\:\ ") + System.integerToTime(Int332)) + ( "\/")) + System.integerToTime(Float331)) + ( "\ \(")) + System.integerToString(Float329)) + ( "\%\)\ ")));
}
}
return Null;
}
...
func7247(( ( ( ( ( ( ( "SEEK\:\ ") + System.integerToTime(Int344)) + ( "\/")) + System.integerToTime(Float343)) + ( "\ \(")) + System.integerToString(Float342)) + ( "\%\)")));
}
return Null;
}
...
func7247(( ( ( ( ( ( ( "SEEK\:\ ") + System.integerToTime(Int356)) + ( "\/")) + System.integerToTime(Float355)) + ( "\ \(")) + System.integerToString(Float354)) + ( "\%\)\ ")));
}
}
return Null;
}
...
func7247(( ( ( ( ( ( ( "SEEK\:\ ") + System.integerToTime(Int364)) + ( "\/")) + System.integerToTime(Float363)) + ( "\ \(")) + System.integerToString(Float362)) + ( "\%\)")));
}
return Null;
}
...
func7247(( ( ( ( ( ( ( "SEEK\:\ ") + System.integerToTime(Int374)) + ( "\/")) + System.integerToTime(Float373)) + ( "\ \(")) + System.integerToString(Float372)) + ( "\%\)\ ")));
}
}
return Null;
}
...
func7247(( ( ( ( ( ( ( "SEEK\:\ ") + System.integerToTime(Int382)) + ( "\/")) + System.integerToTime(Float381)) + ( "\ \(")) + System.integerToString(Float380)) + ( "\%\)")));
}
return Null;
}
...
ToggleButton3Class.onLeftButtonDown(int x, int y)
{
if(( ToggleButton3Class == ToggleButton3Class35)) {
setSuperText(( "Crossfade"));
} else {
if(( ToggleButton3Class == ToggleButton3Class37)) {
setSuperText(( "Repeat"));
} else {
if(( ToggleButton3Class == ToggleButton3Class36)) {
...
ToggleButton3Class.onToggle(Boolean onoff)
{
String String396;
String String398;
String396 = ( "none");
...
func8452(String "0")
{
if(( ( ( ( String419 == ( "thinger")) && ( Int60 == 0)) && ( Int61 == 0)) && Int63)) {
if(( Int62 == 0)) {
Int63 = 0;
...
if(( ( ( ( String419 == ( "thinger")) && ( Int60 == 1)) && ( Int61 == 0)) && Int63)) {
if(( Int62 == 0)) {
Int63 = 0;
Group72.setTargetX(0);
Group72.setTargetY(173);
...
if(( ( ( ( String419 == ( "thinger")) && ( Int60 == 0)) && ( Int61 == 1)) && Int63)) {
if(( Int62 == 0)) {
Int63 = 0;
Group72.setTargetX(0);
Group72.setTargetY(173);
...
if(( ( ( ( String419 == ( "thinger")) && ( Int60 == 1)) && ( Int61 == 1)) && Int63)) {
if(( Int62 == 0)) {
Int63 = 0;
Group72.setTargetX(0);
Group72.setTargetY(173);
...
Layout20.resize(Int436, Int437, Layout20.getWidth(), Layout20.getHeight());
}
...
Layout22.resize(Int436, Int437, Layout22.getWidth(), Layout22.getHeight());
}
...
Layout21.resize(Int436, Int437, Layout21.getWidth(), Layout21.getHeight());
}
return Null;
}
...
Button4Class121.setXmlParam(( "downimage"), ( "player.button.eqs.down"));
Button4Class122.setXmlParam(( "x"), ( "5"));
Button4Class122.setXmlParam(( "image"), ( "player.button.viss"));
Button4Class122.setXmlParam(( "downimage"), ( "player.button.viss.down"));
}
if(( Int527 == 1)) {
...
Button4Class121.setXmlParam(( "downimage"), ( "player.button.eqs2.down"));
Button4Class122.setXmlParam(( "x"), ( "6"));
Button4Class122.setXmlParam(( "image"), ( "player.button.viss2"));
Button4Class122.setXmlParam(( "downimage"), ( "player.button.viss2.down"));
}
return Null;
}
