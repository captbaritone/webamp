...
export default function Vis({ analyser }: Props) {
  useLayoutEffect(() => {
    ...
    analyser.smoothingTimeConstant = 0.3; //Kinda wish I would let the bars themselves have a fall off...
  ...
  useEffect(() => {
    ...
    return () => {
      if (audioStatus === MEDIA_STATUS.STOPPED && animationRequest != null) {
