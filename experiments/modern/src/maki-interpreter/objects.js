const objects = {
  ...
  "6129FEC1DAB74d51916501CA0C1B70DB": {
    functions: [
      ...
      {
        parameters: [["String", "name"], ["Int", "width"], ["Int", "numeric"]],
        name: "addColumn",
        result: "Int"
      },
      {
      ...
      {
        parameters: [["Int", "pos"], ["Int", "subpos"], ["String", "txt"]],
        name: "setSubItem",
        result: ""
      },
      {
      ...
      {
        parameters: [["Int", "col"], ["Int", "x"], ["Int", "y"]],
  ...
  "00C074A0FEA249a0BE8DFABBDB161640": {
    functions: [
      ...
      {
        parameters: [["String", "notifstr"], ["Int", "a"], ["Int", "b"]],
        name: "onNotify",
        result: ""
      },
      {
  ...
  D6F50F6493FA49b793F1BA66EFAE3E98: {
    functions: [
      ...
      {
        parameters: [["String", "str"], ["Int", "start"], ["Int", "len"]],
        name: "strmid",
        result: "String"
      },
      {
  ...
  D40302823AAB4d87878D12326FADFCD5: {
    functions: [
      ...
      {
        parameters: [["String", "attr_name"], ["String", "default_val"]],
        name: "newAttribute",
        result: "ConfigAttribute"
      },
      {
