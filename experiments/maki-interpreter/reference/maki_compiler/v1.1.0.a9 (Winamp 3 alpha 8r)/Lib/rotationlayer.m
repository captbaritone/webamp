...
//
//                       _MyVarInit(String containername, String layoutname, String layername); // init rotationlayer
...
Function _##ROTATION_LAYER_VAR##Init(String containername, String layoutname, String layername);
...
_##ROTATION_LAYER_VAR##Init(String containername, String layoutname, String layername) {
  _##ROTATION_LAYER_VAR##Layer = getContainer(containername).getLayout(layoutname).getObject(layername);
